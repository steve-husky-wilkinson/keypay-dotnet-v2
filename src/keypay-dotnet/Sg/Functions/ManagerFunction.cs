...
namespace KeyPayV2.Sg.Functions
{
    public class ManagerFunction : BaseFunction
    {
        ...
        {
            return ApiRequest<SgTimesheetReferenceData>($"/business/{businessId}/manager/{employeeId}/timesheet/reference", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<SgTimesheetReferenceData>($"/business/{businessId}/manager/{employeeId}/timesheet/reference", Method.Get, cancellationToken);
        }
        ...
        /// details provided.
        /// </remarks>
        public void InitiateEmployeeSelfSetup(int businessId, SgInitiateEmployeeOnboardingApiModel model)
        {
        ...
        /// details provided.
        /// </remarks>
        public Task InitiateEmployeeSelfSetupAsync(int businessId, SgInitiateEmployeeOnboardingApiModel model, CancellationToken cancellationToken = default)
        {
        ...
        {
            return ApiRequest<SgTimeAndAttendanceLookupDataModel>($"/business/{businessId}/manager/kiosk/{kioskId}/lookupdata/{employeeId}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<SgTimeAndAttendanceLookupDataModel>($"/business/{businessId}/manager/kiosk/{kioskId}/lookupdata/{employeeId}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<SgTimeAndAttendanceShiftModel>,GetShiftsModel>($"/business/{businessId}/manager/kiosk/shifts", model, Method.Post);
        }
        ...
        {
            return ApiRequestAsync<List<SgTimeAndAttendanceShiftModel>,GetShiftsModel>($"/business/{businessId}/manager/kiosk/shifts", model, Method.Post, cancellationToken);
        }
        ...
        {
            return ApiRequest<SgRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockoff?kioskId={request.KioskId}&dateUtc={request.DateUtc.ToString("yyyy-MM-ddTHH:mm:ss")}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<SgRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockoff?kioskId={request.KioskId}&dateUtc={request.DateUtc.ToString("yyyy-MM-ddTHH:mm:ss")}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<SgRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockon?kioskId={request.KioskId}&dateUtc={request.DateUtc.ToString("yyyy-MM-ddTHH:mm:ss")}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<SgRosterShiftMatchingResultModel>($"/business/{businessId}/manager/rostershift/{employeeId}/matchingclockon?kioskId={request.KioskId}&dateUtc={request.DateUtc.ToString("yyyy-MM-ddTHH:mm:ss")}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<SgEssRosterShiftModel>>($"/business/{businessId}/manager/rostershift/{employeeId}/nearby?localTime={request.LocalTime.ToString("yyyy-MM-ddTHH:mm:ss")}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<List<SgEssRosterShiftModel>>($"/business/{businessId}/manager/rostershift/{employeeId}/nearby?localTime={request.LocalTime.ToString("yyyy-MM-ddTHH:mm:ss")}", Method.Get, cancellationToken);
        }
        ...
        /// </remarks>
        public SgManagerRosterDataModel ManageRosterData(int businessId, ManageRosterDataQueryModel request)
        {
            return ApiRequest<SgManagerRosterDataModel>($"/business/{businessId}/manager/rostershift/manage?date={request.Date.ToString("yyyy-MM-ddTHH:mm:ss")}&employeeId={request.EmployeeId}&locationId={request.LocationId}&roleId={request.RoleId}&includeCosts={request.IncludeCosts}&includeSubLocations={request.IncludeSubLocations}", Method.Get);
        }
        ...
        /// employee unavailablity, and leave requests.
        /// </remarks>
        public Task<SgManagerRosterDataModel> ManageRosterDataAsync(int businessId, ManageRosterDataQueryModel request, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<SgManagerRosterDataModel>($"/business/{businessId}/manager/rostershift/manage?date={request.Date.ToString("yyyy-MM-ddTHH:mm:ss")}&employeeId={request.EmployeeId}&locationId={request.LocationId}&roleId={request.RoleId}&includeCosts={request.IncludeCosts}&includeSubLocations={request.IncludeSubLocations}", Method.Get, cancellationToken);
        }
        ...
        /// Create an individual timesheet line
        /// </remarks>
        public IndividualTimesheetLineModel CreateTimesheetLine(int businessId, IndividualTimesheetLineModel request)
        {
            return ApiRequest<IndividualTimesheetLineModel,IndividualTimesheetLineModel>($"/business/{businessId}/manager/timesheet", request, Method.Post);
        }
        ...
        /// Create an individual timesheet line
        /// </remarks>
        public Task<IndividualTimesheetLineModel> CreateTimesheetLineAsync(int businessId, IndividualTimesheetLineModel request, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<IndividualTimesheetLineModel,IndividualTimesheetLineModel>($"/business/{businessId}/manager/timesheet", request, Method.Post, cancellationToken);
        }
        ...
        /// Update an individual timesheet line
        /// </remarks>
        public IndividualTimesheetLineModel UpdateTimesheetLine(int businessId, int timesheetLineId, IndividualTimesheetLineModel request)
        {
            return ApiRequest<IndividualTimesheetLineModel,IndividualTimesheetLineModel>($"/business/{businessId}/manager/timesheet/{timesheetLineId}", request, Method.Put);
        }
        ...
        /// Update an individual timesheet line
        /// </remarks>
        public Task<IndividualTimesheetLineModel> UpdateTimesheetLineAsync(int businessId, int timesheetLineId, IndividualTimesheetLineModel request, CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<IndividualTimesheetLineModel,IndividualTimesheetLineModel>($"/business/{businessId}/manager/timesheet/{timesheetLineId}", request, Method.Put, cancellationToken);
        }
        ...
        /// </remarks>
        public List<SgAvailableBusinessModel> ListBusinesses()
        {
            return ApiRequest<List<SgAvailableBusinessModel>>($"/manager/security/businesses", Method.Get);
        }
        ...
        /// Returns all the businesses the user can access.
        /// </remarks>
        public Task<List<SgAvailableBusinessModel>> ListBusinessesAsync(CancellationToken cancellationToken = default)
        {
            return ApiRequestAsync<List<SgAvailableBusinessModel>>($"/manager/security/businesses", Method.Get, cancellationToken);
        }
    }
}
