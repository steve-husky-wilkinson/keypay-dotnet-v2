...
namespace KeyPayV2.Uk.Functions
{
    public class TimeAndAttendanceFunction : BaseFunction
    {
        ...
        {
            return ApiRequest<UkTimeAndAttendanceLookupDataModel>($"/business/{businessId}/kiosk/{kioskId}/lookupdata/{employeeId}", Method.Get);
        }
        ...
        {
            return ApiRequestAsync<UkTimeAndAttendanceLookupDataModel>($"/business/{businessId}/kiosk/{kioskId}/lookupdata/{employeeId}", Method.Get, cancellationToken);
        }
        ...
        {
            return ApiRequest<List<UkTimeAndAttendanceShiftModel>,GetShiftsModel>($"/business/{businessId}/kiosk/shifts", model, Method.Post);
        }
        ...
        {
            return ApiRequestAsync<List<UkTimeAndAttendanceShiftModel>,GetShiftsModel>($"/business/{businessId}/kiosk/shifts", model, Method.Post, cancellationToken);
        }
    }
}
